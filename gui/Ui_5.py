...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_return = QLabel(self.centralwidget)
        self.label_return.setObjectName(u"label_return")
        self.label_return.setGeometry(QRect(250, 170, 321, 71))
        font = QFont()
        font.setPointSize(14)
        font.setHintingPreference(QFont.PreferDefaultHinting)
        self.label_return.setFont(font)
        self.label_return.setCursor(QCursor(Qt.ArrowCursor))
        self.label_return.setTextFormat(Qt.AutoText)
        self.label_return.setAlignment(Qt.AlignCenter)
